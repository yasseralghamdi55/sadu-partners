...
export default function Home() {
  ...
  const content = {
      ...
      services: [
        {
          ...
          description:
            'مراجعة القوائم المالية والتقارير وفق المعايير والأنظمة المعتمدة داخل المملكة.',
        },
        {
          title: 'الخدمات المحاسبية',
          description:
            'إعداد السجلات والدفاتر والتقارير المالية الدورية بدقة وكفاءة تشغيلية.',
        },
        {
          title: 'الزكاة والضرائب',
          description:
            'خدمات الامتثال الزكوي والضريبي وضريبة القيمة المضافة وتمثيل المنشآت أمام الجهات ذات العلاقة.',
        },
        {
          title: 'الاستشارات المالية والإدارية',
          description:
            'حلول مالية وإدارية تساعد في رفع الكفاءة وتحسين الأداء ودعم اتخاذ القرار.',
        },
        {
          title: 'الحوكمة والضوابط الداخلية',
          description:
            'وضع السياسات والإجراءات وبناء أنظمة رقابية تدعم الاستدامة والامتثال.',
        },
        {
          title: 'الفحص النافي للجهالة',
          description:
            'فحوصات مالية ومحاسبية لدعم المستثمرين وتقييم الفرص وتقليل المخاطر.',
        },
      ],
      ...
      whyCards: [
        {
          ...
          title: 'فهم محلي قوي',
          description:
            'معرفة عملية بمتطلبات البيئة النظامية والمالية في المملكة العربية السعودية.',
        },
        {
          number: '02',
          title: 'منهجية دقيقة',
          description:
            'اعتماد معايير واضحة لضمان جودة المخرجات وسلامة الإجراءات والتقارير.',
        },
        {
          number: '03',
          title: 'شراكة مبنية على الثقة',
          description:
            'تواصل مهني وسرية عالية وحرص على تقديم قيمة حقيقية لكل عميل.',
        },
      ],
      contactLabel: 'تواصل معنا',
      contactTitle: 'جاهزون لخدمتكم',
      contactText:
        'يسعدنا استقبال استفساراتكم وتقديم الدعم المهني المناسب لاحتياجات منشأتكم.',
      city: 'المدينة',
      cityValue: 'الرياض',
      country: 'الدولة',
    ...
    en: {
      ...
      heroTitle:
        'Professional expertise that strengthens trust and supports business growth',
      heroText:
      ...
      servicesTitle:
        'Integrated professional services tailored to business needs',
      servicesText:
      ...
      services: [
        {
          ...
          description:
            'Reviewing financial statements and reports in line with applicable standards and regulations in Saudi Arabia.',
        },
        {
          title: 'Accounting Services',
          description:
            'Maintaining accounting records, bookkeeping, and preparing periodic financial reports with accuracy and efficiency.',
        },
        {
          title: 'Zakat & Tax',
          description:
            'Supporting VAT, zakat, and tax compliance requirements and representing clients before relevant authorities.',
        },
        {
          title: 'Financial & Management Advisory',
          description:
            'Practical advisory solutions that improve performance, efficiency, and strategic decision-making.',
        },
        {
          title: 'Governance & Internal Controls',
          description:
            'Developing policies, procedures, and control frameworks that support sustainability and compliance.',
        },
        {
          title: 'Due Diligence',
          description:
            'Financial and accounting due diligence to support investors, evaluate opportunities, and reduce risk.',
        },
      ],
      whyUsLabel: 'Why Us',
      ...
      whyCards: [
        {
          ...
          description:
            'Practical knowledge of the Saudi regulatory and financial environment.',
        },
        {
          number: '02',
          title: 'Precise methodology',
          description:
            'Clear professional standards that ensure quality outputs and sound procedures.',
        },
        {
          number: '03',
          title: 'Trust-based partnership',
          description:
            'Professional communication, high confidentiality, and real value for every client.',
        },
      ],
      contactLabel: 'Contact Us',
      contactTitle: 'We are ready to support you',
      contactText:
        'We are pleased to receive your inquiries and provide the right professional support for your business needs.',
      city: 'City',
      cityValue: 'Riyadh',
      country: 'Country',
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a href="#home" className="text-sm font-medium text-slate-700 hover:text-slate-950">
              {t.nav.home}
            </a>
            <a href="#about" className="text-sm font-medium text-slate-700 hover:text-slate-950">
              {t.nav.about}
            </a>
            <a href="#services" className="text-sm font-medium text-slate-700 hover:text-slate-950">
              {t.nav.services}
            </a>
            <a href="#why-us" className="text-sm font-medium text-slate-700 hover:text-slate-950">
              {t.nav.whyUs}
            </a>
            <a href="#contact" className="text-sm font-medium text-slate-700 hover:text-slate-950">
              {t.nav.contact}
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden rounded-xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white shadow-lg md:inline-flex"
            >
              {t.whatsapp}
            </a>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.1fr_0.9fr] md:items-center md:py-20">
          <div className="relative z-10">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="rounded-2xl bg-slate-950 px-6 py-3 text-sm font-semibold text-white shadow-xl transition hover:-translate-y-0.5"
              >
                {t.primaryCta}
              </a>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <a
                    ...
                    className="mt-2 block text-lg font-bold text-slate-900"
                  >
                    {company.phone}
                  </a>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <a
                    ...
                    className="mt-2 block break-all text-lg font-bold text-slate-900"
                  >
                    {company.email}
                  </a>
                </div>
      ...
      <section id="about" className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="rounded-[2rem] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-8 text-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] md:p-10">
            <div className="text-sm font-bold uppercase tracking-[0.2em] text-white/60">
              {t.highlightTitle}
            </div>
            <div className="mt-6 grid gap-4">
              {t.highlights.map((item) => (
                <div
                  key={item}
                  className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm leading-7 text-white/90"
                >
                  {item}
                </div>
              ))}
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {t.services.map((service) => (
              ...
              >
                <div className="inline-flex rounded-2xl bg-slate-950 px-3 py-2 text-xs font-bold text-white">
                  {service.title}
                </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="mt-8 grid gap-4">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                ...
                <div className="mt-2 text-lg font-bold">
                  {isArabic ? company.addressAr : company.addressEn}
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                  ...
                  <a href={`tel:${company.phone}`} className="mt-2 block text-lg font-bold">
                    {company.phone}
                  </a>
                </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:p-8">
            <div className="grid gap-4">
              ...
              />
              <textarea
                className="min-h-[160px] rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-white outline-none placeholder:text-white/45"
                placeholder={t.formMessage}
              />
              <button className="rounded-2xl bg-white px-5 py-3 font-bold text-slate-950 transition hover:-translate-y-0.5">
                {t.formButton}
              </button>
            </div>
          </div>
